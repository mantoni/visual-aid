...
- Markdown is rendered into simple semantic HTML for headings, paragraphs, lists, tables, links, syntax-highlighted fenced code blocks, and embedded Mermaid fences.
